    	...
    	<div class="container" style="padding-top: 10px;">
        	<!-- <div class="row footer-row">
                ...
                <div class="span3 footer-col">
                    <h5>Flickr Photos</h5>
                    <ul class="img-feed">
                        <li><a href="#"><img src="<?=base_url('assets/piccolo') ?>/img/gallery/flickr-img-1.jpg" alt="Image Feed"></a></li>
                        <li><a href="#"><img src="<?=base_url('assets/piccolo') ?>/img/gallery/flickr-img-1.jpg" alt="Image Feed"></a></li>
                        <li><a href="#"><img src="<?=base_url('assets/piccolo') ?>/img/gallery/flickr-img-1.jpg" alt="Image Feed"></a></li>
                        <li><a href="#"><img src="<?=base_url('assets/piccolo') ?>/img/gallery/flickr-img-1.jpg" alt="Image Feed"></a></li>
                        <li><a href="#"><img src="<?=base_url('assets/piccolo') ?>/img/gallery/flickr-img-1.jpg" alt="Image Feed"></a></li>
            ...
            <div class="row"><!-- Begin Sub Footer -->
                <div class="span12 footer-col footer-sub">
                    <div class="row no-margin">
                        ...
                        <div class="span6">
                            <span class="right">
                            <a href="<?=base_url('index.php')?>">Home</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="<?=base_url('index.php/student/get_facilities/distinct')?>">Facilities</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="#">Login</a>
                            </span>
                        </div>
                    </div>
                </div>
