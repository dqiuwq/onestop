...
<link rel="stylesheet" href="<?=base_url('assets/piccolo') ?>/css/bootstrap_admin.css">
        ...
        <div class="row header"><!-- Begin Header -->
            ...
            <div class="span7 navigation">
                <div class="navbar hidden-phone">
    	            <ul class="nav">
        				<!-- <li class="active"> -->
                        <li><a href="<?=base_url('index.php/get_admin_home') ?>">Home</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?=base_url('index.php/admin/get_bookings/today') ?>">Today</a></li>
                                <li><a href="<?=base_url('index.php/admin/get_bookings/future') ?>">Future</a></li>
                                <li><a href="<?=base_url('index.php/admin/get_bookings/history') ?>">History</a></li>
                            </ul>
                        </li>
                        <li><a href="<?=base_url('index.php/admin/get_users') ?>">System Admin</a></li>
